...
# Required arguments
unless( defined $method and defined $position and defined $output_file )
{
	print `perldoc $0`;
	exit 1;
}
...
sub main()
{
	...
	$logger->info("export_method_annots:$position:finished ---------------\n");
...
=head2 Required arguments:
	...
	--method= <Name of Method(s)> (matador3d,spade,inertia)
...
=head1 EXAMPLE
	...
	perl export_method_annots.pl
		
		--method=matador3d,spade,inertia
		
		--position=chr21
		
		--output_dir=../features/annotations/chr21/
