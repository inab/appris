...
sub query_appris {
	...
	if (keys(%args)){ pop @args;}  # remove final "and"
		...
		exon_conservation_signal,
		transmembrane_helices_signal,
		peptide_signal,
		mitochondrial_signal,
		principal_isoform_signal,
		functional_residues_rscore,
		homologous_structure_rscore,
		vertebrate_conservation_rscore,
		domain_rscore,
		unusual_evolution_rscore,
		exon_conservation_rscore,
		transmembrane_helices_rscore,
		peptide_mitochondrial_rscore,
		principal_isoform_rscore,
		reliability,
...
sub insert_cexonic {
	...
	eval {
	$dbh->do(q{insert into cexonic (entity_id, result, num_introns, first_specie_num_exons, second_specie_num_exons, conservation_exon) values (?,?,?,?,?,?)},
			undef,(
				$args{'entity_id'},
				$args{'result'},
				$args{'num_introns'},
...
sub insert_cexonic_residues {
	...
	eval {
	$dbh->do(q{insert into cexonic_residues (cexonic_id, trans_start, trans_end, trans_strand) values (?,?,?,?)},
			undef,(
				$args{'cexonic_id'},
				$args{'trans_start'},
				$args{'trans_end'},
...
sub insert_appris {
	...
	$dbh->do(q{insert into appris (
			...
			undef,(
				...
				$args{'exon_conservation_signal'},
				$args{'transmembrane_helices_signal'},
				$args{'peptide_signal'},
				$args{'mitochondrial_signal'},
				$args{'principal_isoform_signal'},				
				$args{'functional_residues_rscore'},
				$args{'homologous_structure_rscore'},
				$args{'vertebrate_conservation_rscore'},
				$args{'domain_rscore'},
				$args{'unusual_evolution_rscore'},
				$args{'exon_conservation_rscore'},
				$args{'transmembrane_helices_rscore'},
				$args{'peptide_mitochondrial_rscore'},				
				$args{'principal_isoform_rscore'},				
				$args{'reliability'},
