...
=head2 new
  ...
  Arg [-slr]: (optional)
        APPRIS::Analysis::SLR - the SLR result for this analysis
...
=head2 slr
  ...
  Arg [1]    : (optional) APPRIS::Analysis::SLR - 
               the SLR result for this analysis 
  Example    : $analysis->slr($residues);
  Description: Getter/setter for the SLR result for this analysis 
  Returntype : APPRIS::Analysis::OmegaRegion or undef
  Exceptions : none
  Caller     : general
  Status     : Stable
