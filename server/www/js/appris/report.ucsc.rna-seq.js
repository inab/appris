...
function getRNASeqUCSCGenomeBrowser(sQueryId, sSpecie)
{
		...
		success: function(data) {
			if (data == null) {
				...
				if (data.error) {
					...
					$('#ucsc_rnaseq_panel table.ucsc_img_head').css({ 'background-image': "url('"+APPRIS.UCSC_IMG_BG+"')" });				
		...
		success: function(data) {
			if (data == null) {
				...
				if (data.error) {
					...
					$('#ucsc_rnaseq_panel table.ucsc_img_data').css({ 'background-image': "url('"+APPRIS.UCSC_IMG_BG+"')" });
