...
=head2 new
  ...
  Arg [-stable_id] : (optional)
        string - the stable identifier of this peptide
...
=head2 cds_sequence
  ...
  Arg [1]    : (optional) Listref of APPRIS::ProCDS - the set of 
               sequence of CDS that for this translation
