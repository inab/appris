...
# $Id: MySQL.pm 1564 2011-06-05 18:17:44Z jmrodriguez $
# $Revision: 1564 $
# Developed by:
...
# Version coming from Iakes
#sub insert_matador3d {
#	my ($self, %args) = @_;
#	my $dbh = $self->dbh;
#
#	eval {
#	$dbh->do(q{insert into matador3d (entity_id, result, conservation_structure) values (?,?,?)},
#			undef,(
#				$args{'entity_id'},
#				$args{'result'},
#				$args{'conservation_structure'} ));
...
#}
#
#sub insert_matador3d_residues {
#	my ($self, %args) = @_;
#	my $dbh = $self->dbh;
#
#	eval {
#	$dbh->do(q{insert into matador3d_residues (matador3d_id, peptide_position, start, end, strand) values (?,?,?,?,?)},
#			undef,(
#				$args{'matador3d_id'},
#				$args{'peptide_position'},
#				$args{'start'},
...
#}
#
#sub insert_matador3d_pdbs {
#	my ($self, %args) = @_;
#	my $dbh = $self->dbh;
#
#	eval {
#	$dbh->do(q{insert into matador3d_pdbs (matador3d_residues_id, name, evalue, coverage, identity, num_gaps) values (?,?,?,?,?,?)},
#			undef,(
#				$args{'matador3d_residues_id'},
#				$args{'name'},
#				$args{'evalue'},
#				$args{'coverage'},
#				$args{'identity'},
...
sub insert_appris {
	...
	eval {
	$dbh->do(q{insert into appris ( entity_id,
                                    source,
                                    functional_residue,
                                    conservation_structure,
                                    un_evolution_ver_conservation,
                                    ...
                                    mitochondrial_signal,
                                    transmembrane_signal,
									principal_isoform ) values (?,?,?,?,?,?,?,?,?,?,?,?,?)},
			undef,(
				$args{'entity_id'},
				$args{'source'},
				$args{'functional_residue'},
				$args{'conservation_structure'},
				$args{'un_evolution_ver_conservation'},
				$args{'domain_signal'},
				$args{'conservation_exon'},
				$args{'vertebrate_signal'},
				$args{'unusual_evolution'},
...
print STDERR "ST: $statement BIND: @bindvalues\n";
